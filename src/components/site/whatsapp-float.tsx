...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className={`group fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_28px_rgba(37,211,102,0.45)] transition-all duration-300 hover:scale-110 hover:shadow-[0_12px_36px_rgba(37,211,102,0.55)] sm:h-[60px] sm:w-[60px] ${
        show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"
      }`}
    >
      <svg viewBox="0 0 32 32" fill="currentColor" className="h-7 w-7 sm:h-[30px] sm:w-[30px]">
